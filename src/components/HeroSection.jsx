...
export default function HeroSection() {
  return (
    <div className="text-center py-12 px-4">
      <h1 className="text-4xl md:text-7xl font-bold text-pink-600">
        HESDIHÁ
      </h1>
      <p className="text-pink-500 text-lg mb-2">izis</p>
      
      <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-6 max-w-md mx-auto mt-6">
        <h2 className="text-2xl font-semibold text-pink-700">Sobre nós</h2>
